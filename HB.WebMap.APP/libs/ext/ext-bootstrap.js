...
(function () {
    ...
    document.write(
        ...
        '<link rel="stylesheet" charset="UTF-8" href="' + path + 'classic/theme-triton/resources/theme-triton-all' + (isDevelopment ? '-debug' : '') + '.css" type="text/css"></link>',
        '<link rel="stylesheet" href="assets/css/index.css">',
        '<script type="text/javascript" charset="UTF-8" src="' + path + 'ext-all' + (isDevelopment ? '-debug' : '') + '.js"></script>',
        '<script type="text/javascript" charset="UTF-8" src="' + path + 'classic/locale/locale-zh_CN' + (isDevelopment ? '-debug' : '') + '.js"></script>',
        '<script type="text/javascript" charset="UTF-8" src="' + path + 'classic/theme-triton/theme-triton' + (isDevelopment ? '-debug' : '') + '.js"></script>',
        '<script type="text/javascript" src="libs/supermap/libs/SuperMap.Include.js"></script>',
        '<script type="text/javascript" src="libs/custom/common/common.js"></script>');
})();
